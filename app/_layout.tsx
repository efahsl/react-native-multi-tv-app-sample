...
export default function IndexScreen() {
  ...
  const [headerImage, setHeaderImage] = useState(require('@/assets/images/movie.png'));
    ...
    const renderItem = ({ item, index }: { item: CardData; index: number }) => (
      ...
      >
        {({ isFocused }) => (
          ...
          //   </View>
          // </View>
          <MovieCard item={item} isFocused={isFocused} />
        )}
      </SpatialNavigationFocusableView>
    );
...
const moviesData = [
  {
    ...
    headerImage: require("@/assets/images/movie1-xs.png"),
    duration: 100,
  },
  {
    id: 6,
    ...
    headerImage: require("@/assets/images/movie7-xs.png"),
    duration: 130,
  },
  {
    id: 1,
    ...
    headerImage: require("@/assets/images/movie2-xs.png"),
    duration: 110,
  },
  {
    id: 4,
    ...
    headerImage: require("@/assets/images/movie5-xs.png"),
    duration: 115,
  },
  {
    id: 2,
    ...
    headerImage: require("@/assets/images/movie3-xs.png"),
    duration: 120,
  },
  {
    id: 3,
    ...
    headerImage: require("@/assets/images/movie4-xs.png"),
    duration: 95,
  },

  {
    ...
    headerImage: require("@/assets/images/movie6-xs.png"),
    duration: 105,
  },
  {
    id: 7,
    ...
    headerImage: require("@/assets/images/movie8-xs.png"),
    duration: 90,
  },
  {
    id: 9,
    ...
    headerImage: require("@/assets/images/movie10-xs.png"),
    duration: 140,
  },
  {
    id: 10,
    ...
    headerImage: require("@/assets/images/movie11-xs.png"),
    duration: 100,
  },
  {
    id: 11,
    ...
    headerImage: require("@/assets/images/movie12-xs.png"),
    duration: 115,
  },
  {
    id: 12,
    ...
    headerImage: require("@/assets/images/movie13-xs.png"),
    duration: 120,
  },
  {
    id: 13,
    ...
    headerImage: require("@/assets/images/movie14-xs.png"),
    duration: 100,
  },
  {
    id: 14,
    ...
    headerImage: require("@/assets/images/movie15-xs.png"),
    duration: 85,
  },
];
